...
// ctx.fillText("Checkers", canvas.width / 2 - 100, canvas.height / 2 + 20);
...
//   // random x and y
//   this.x =
//     Math.floor(Math.random() * (width - this.radius + 1)) + this.radius;
//   this.y =
//     Math.floor(Math.random() * (width - this.radius + 1)) + this.radius;
...
//   this.col = rcol == 0 ? "red" : rcol == 1 ? "yellow" : "green";
// }
